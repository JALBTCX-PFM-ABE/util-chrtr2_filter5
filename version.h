...
#define     VERSION     "PFM Software - chrtr2_filter5 V1.05 - 07/23/14"
...
/*
    ...
    Removed half node shift since it is not needed in grid registration
    Removed coarse grid calculation based on node center lat/lon
